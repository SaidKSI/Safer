...
class AirController extends Controller
{
    ...
    public function delete_airline($id)
    {
        ...
        if ($airline) {
            ...
            // Show success message
            return redirect('/admin/airlines')->with(['type' => 'success', 'message' => 'Airline Deleted successfully'], 201);
        } else {
            // Show error message
            return  redirect('/admin/airlines')->with(['type' => 'danger', 'message' => 'Error'], 403);
        }
    }
}
